...
import com.bosspvp.api.misc.recipe.impl.ShapedCraftingRecipe;
...
public class Recipes {
    ...
    public static CraftingRecipe getRecipe(@NotNull final NamespacedKey key) {
        ...
        if (key.getKey().contains("_displayed")) {
            NamespacedKey otherKey = new NamespacedKey(
                    key.getNamespace(),
     ...
     * @return The recipe.
     */
    public static CraftingRecipe createAndRegisterRecipe(@NotNull final BossPlugin plugin,
    ...
    public static CraftingRecipe createAndRegisterRecipe(@NotNull final BossPlugin plugin,
        ...
        if (builder.isAir()) {
            plugin.getLogger().warning("Crafting recipe " + plugin.getName() + ":" + key + " consists only");
